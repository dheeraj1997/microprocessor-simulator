...
public class DcrCommandExecutor extends CommandExecutor {

  public static String commandName = "DCR";

  public DcrCommandExecutor(final RegisterState registerState) {
    super(registerState);
  }
